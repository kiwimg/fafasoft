...
package com.fafasoft.flow.ui.widget.tip;
...
import com.fafasoft.flow.ui.widget.tip.positioners.BalloonTipPositioner;
import com.fafasoft.flow.ui.widget.tip.positioners.BasicBalloonTipPositioner;
import com.fafasoft.flow.ui.widget.tip.positioners.LeftAbovePositioner;
...
import com.fafasoft.flow.ui.widget.tip.positioners.RightBelowPositioner;
import com.fafasoft.flow.ui.widget.tip.styles.BalloonTipStyle;
...
//
//	private static Icon defaultCloseIcon  = null;
//	private static Icon rolloverCloseIcon = null;
//	private static Icon pressedCloseIcon  = null;
    ...
    public BalloonTip(JComponent attachedComponent, JLabel text) {
		this(attachedComponent, text, new RoundedBalloonStyle(5,5,Color.WHITE, Color.BLACK), true);
	}
	/**
	 * Constructor
	...
	public BalloonTip(final JComponent attachedComponent, final JComponent contents, final BalloonTipStyle style, Orientation orientation, AttachLocation attachLocation,
		...
		setup(attachedComponent, contents, style, positioner,null);
	}
